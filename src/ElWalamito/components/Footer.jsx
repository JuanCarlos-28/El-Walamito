...
export function Footer() {
    return (
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 bg-gray-900 text-center md:justify-between">
            <img src="./assets/images/LOGO WALAMITO perfil.png" alt="logo-ct" className="w-32" />
        ...
        <Typography color="blue-gray" className="text-center font-normal flex gap-4 justify-center">
                <a href="#" target="_blank" rel="noreferrer">
                    <img src="./assets/images/icons8-whatsapp.svg" alt="Logo Instagram" className="w-20" />
                </a>
                <a href="#" target="_blank" rel="noreferrer">
                    <img src="./assets/images/icons8-facebook-nuevo.svg" alt="Logo Facebook" className="w-20" />
                </a>
                <a href="#" target="_blank" rel="noreferrer">
                    <img src="./assets/images/icons8-instagram.svg" alt="Logo Instagram" className="w-20" />
                </a>
        </Typography>
        </footer>
    );
